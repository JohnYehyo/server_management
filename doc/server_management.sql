...
CREATE TABLE `server_info`  (
  ...
  `server_name` tinyint(1) NOT NULL COMMENT '服务名',
  ...
  `package_type` tinyint(1) NOT NULL COMMENT '包类型',
...
-- ----------------------------
INSERT INTO `server_info` VALUES (1, 7, 'http://localhost:8083', 'D:/tool/apache-tomcat-8.5.55-test/', 0, 'test', 'file/rjcloud-sysweb.war', 0, 2);
INSERT INTO `server_info` VALUES (2, 7, 'http://32.0.7.11:8083', 'D:/tool/apache-tomcat-8.5.55-test/', 1, 'test', 'file/rjcloud-sysweb.war', 0, 2);
